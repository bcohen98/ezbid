...
import { useProposal, useProposalLineItems } from '@/hooks/useProposals';
          ...
          <div className="space-y-4">
            <div className="border rounded-lg p-4 space-y-3">
              ...
              <Textarea
                ...
                rows={4}
              />
              <Button variant="outline" size="sm" className="w-full" disabled={!revisionNote.trim()}>
                Submit revision (AI — coming soon)
              </Button>
            </div>

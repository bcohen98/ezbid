...
import { BarChart3, Users, FileText, DollarSign, ChevronLeft, Activity, Gift, Database, Award } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/ambassadors', label: 'Ambassadors', icon: Award },

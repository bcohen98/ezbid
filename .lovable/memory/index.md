...
Supabase for auth/DB/storage. Tables: company_profiles, proposals, proposal_line_items, user_subscriptions, user_roles.
Free tier: 3 proposals, then $29/mo Stripe subscription.
...
- [Admin dashboard](mem://features/admin) — Protected /admin with Overview, Users, Proposals, Revenue; user_roles table
